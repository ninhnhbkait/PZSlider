                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <?php echo $this->Html->image('/admin/img/avatar.png',array('class'=>'online','alt'=>'User Image'));?>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                    <?php echo $this->Html->image('/admin/img/avatar2.png',array('class'=>'offline','alt'=>'User Image'));?>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <?php echo $this->Html->image('/admin/img/avatar3.png',array('class'=>'offline','alt'=>'User Image'));?>
                                        <p class="message">
                                            <a href="#" class="name">
